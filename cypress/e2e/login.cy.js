...
//     const columnToFind=Cypress.env('column')
//     const textToFind=Cypress.env('user_assign')
//     const $SpecificColumn=$body.find(columnToFind)
//     const $SpecificText = $SpecificColumn.filter(`:contains("${textToFind}")`)
//     if ($SpecificText.length >0){
//         cy.log("the found row is :",$SpecificText.text())
//         cy.wrap($SpecificText).within(()=>{
//             cy.get(inst.assign_inst).click()
//             cy.xpath(inst.assign_confirm_xpath).click()
